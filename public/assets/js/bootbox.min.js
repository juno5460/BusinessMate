			...
			l = {}, g = {}, m = {
				...
				dialog: function(b, a, c) {
					...
					for (var d = a.length; d--;) {
						...
						a[d]["class"] ? j = a[d]["class"] : d == a.length - 1 && 2 >= a.length && (j = "btn-success");
						g = a[d].label ? a[d].label : "Option " + (d + 1);
						a[d].icon && (m = "<i class='" + a[d].icon + "'></i> ");
						k = a[d].href ? a[d].href : "javascript:;";
						h = "<a data-handler='" + d + "' class='btn btn-mini span1 pull-right " + j + "' href='" + k + "'>" + m + "" + g + "</a>" + h;
						l[d] = p
					}
					d = ["<div class='widget-boxx modal ' tabindex='-1' style='overflow:hidden;'>"];
					if (c.header) {
						j = "";
						//if ("undefined" == typeof c.headerCloseButton || c.headerCloseButton) j = "<a href='javascript:;' class='close'>&times;</a>";
						d.push("<div class='widget-header header-color-blue'>" + j + "<h5 class='bigger lighter'>" + c.header + "</h5></div>")
					}
					d.push("<div class='widget-body'><div class='widget-body-inner'>");
					//d.find(".widget-body-inner")
					h && d.push("<div class='widget-main'>" + h + "</div>");
					d.push("<div class='widget-toolbox padding-8 clearfix'>" + h + "</div></div></div>");
					d.push("</div>");
					var f = n(d.join("\n"));
					("undefined" === typeof c.animate ? u : c.animate) && f.addClass("fade");
					(h = "undefined" === typeof c.classes ? v : c.classes) && f.addClass(h);
					f.find(".widget-main").html(b);
					...
					f.on("shown", function() {
						f.find("a.btn-success:first").focus()
					});
					f.on("hidden", function() {
						f.remove()
					});
					f.on("click", ".widget-toolbox a", function(b) {
